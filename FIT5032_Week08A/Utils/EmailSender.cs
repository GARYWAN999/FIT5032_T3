...
namespace FIT5032_Week08A.Utils
{
    public class EmailSender
    {
        ...
        private const String API_KEY = "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";

        public void Send(String toEmail, String subject, String contents, HttpPostedFileBase postedFile)
        {
            var client = new SendGridClient(API_KEY);
            var from = new EmailAddress("502824312@qq.com", "FIT5032 Example Email User");
